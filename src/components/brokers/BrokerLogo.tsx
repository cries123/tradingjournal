...
// small badge thumbnail of the real logo, paired with a plain-text broker name at a consistent size.
  ...
  if (key) {
    ...
    return (
      <div className={`flex items-center gap-3 ${className}`}>
        <span className="w-14 h-14 rounded-xl bg-white border border-border/60 flex items-center justify-center shrink-0 p-2">
          <img src={b.src} alt="" aria-hidden className="w-full h-full object-contain" />
        </span>
