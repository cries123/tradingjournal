    ...
    <div className="pb-6">
      <div className="max-w-4xl mx-auto p-4 md:p-6">
        ...
        <p className="text-text-secondary text-base leading-relaxed max-w-2xl mb-10">
          Connect any of the 20 brokers below for automatic, read-only trade sync — or skip connecting
          entirely and log trades yourself. Either way, you&apos;re in control.
        </p>
